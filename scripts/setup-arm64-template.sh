...
IMAGE_URL="https://cloud.debian.org/images/cloud/trixie/daily/latest/debian-trixie-nocloud-arm64-daily.qcow2"
IMAGE_PATH="/var/lib/vz/template/iso/debian-trixie-nocloud-arm64.qcow2"
